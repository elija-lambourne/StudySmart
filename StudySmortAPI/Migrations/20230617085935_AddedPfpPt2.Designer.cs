...
namespace StudySmortAPI.Migrations
{
    ...
    [Migration("20230617085935_AddedPfpPt2")]
    partial class AddedPfpPt2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudySmortAPI.Model.ProfilePicture", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("StudySmortAPI.Model.ProfilePicture", b =>
                {
                    b.HasOne("StudySmortAPI.Model.User", "Owner")
                        ...
                        .HasForeignKey("StudySmortAPI.Model.ProfilePicture", "OwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
